...
export default function GitHubTokenWarning() {
  ...
  return (
    <div className="mx-auto mt-3 max-w-2xl">
      <div className="flex items-start gap-2 rounded-card border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
        ...
        <button
          ...
          className="shrink-0 rounded p-0.5 text-amber-500 transition-colors hover:text-amber-700 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0"
          aria-label="关闭"
        >
